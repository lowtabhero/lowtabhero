...
I build websites and web tools with a focus on practical implementation, integrations, and production-ready delivery using SvelteKit, JavaScript, React, PHP, SQL, and headless WordPress.
...
experience: {
  ...
  "Side Projects": {
    highlights: [
      "Built a multilingual website using SvelteKit with content separated by language-specific JSON files",
      "Integrated WordPress blog content into the website",
      "Managed deployment workflow with GitHub and Vercel"
    ],
    links: [
      "lumicacenter.com"
    ]
...
education: {
  degree: "FP Grado Superior de Desarrollo Web",
  location: "Spain"
}
```
